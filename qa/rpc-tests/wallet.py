...
#   c) node1 mines 101 blocks, so now nodes 0 and 1 have 500 FORT, node2 has none. 
#   d) node0 sends 21 FORT to node2, in two transactions (11 FORT, then 10 FORT).
...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 21 FORT from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 FORT in block rewards plus fees, but
