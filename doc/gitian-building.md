...
```bash
    ...
    From https://github.com/Fortcoinpay/Fortcoin
...
[Fortcoin/gitian.sigs](https://github.com/Fortcoinpay/gitian.sigs/) repository, or if that's not possible to create a pull
request.
